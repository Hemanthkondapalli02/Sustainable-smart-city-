...
st.markdown("""
    <style>
    .stApp {
        background: linear-gradient(135deg, #0b0f1a 0%, #101820 100%);
        color: #e2e8f0;
    }

    .css-1d391kg {
        background: linear-gradient(180deg, #1b1f26 0%, #222931 100%);
    }
    ...
    .metric-container {
        background: linear-gradient(135deg, #1a1f2e 0%, #243248 100%);
        border-radius: 10px;
        padding: 1rem;
    ...
    .stButton > button {
        background: linear-gradient(135deg, #00FFAB 0%, #00B2FF 100%);
        color: black;
        border: none;
        border-radius: 25px;
        padding: 0.5rem 2rem;
        ...
        box-shadow: 0 4px 20px rgba(0, 255, 171, 0.3);
    }

    .stButton > button:hover {
        transform: translateY(-2px);
        box-shadow: 0 8px 25px rgba(0, 255, 171, 0.5);
    }
    ...
    .footer {
        background: linear-gradient(135deg, #101820 0%, #1f2c3a 100%);
        padding: 1rem;
        border-radius: 10px;
